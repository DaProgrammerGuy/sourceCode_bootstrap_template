    ...
    <ul class="navbar-nav ml-auto">
        ...
        @role('admin')
            <li class="nav-item {{ request()->routeIs('admin.conversations.*') ? 'active' : '' }}">
                <a class="nav-link" href="{{ route('admin.conversations.index') }}">
        ...
        <!-- Teacher Menu -->
        @role('teacher')
            <li class="nav-item {{ request()->routeIs('teacher.conversations.*') ? 'active' : '' }}">
                <a class="nav-link" href="{{ route('teacher.conversations.index') }}">
